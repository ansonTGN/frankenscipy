fn main() {
    ...
    let sample = vec![
        0.55130587, 0.15176798, 0.05130587, 0.81843465, 0.80130587, 0.48510131, 0.30130587,
        0.26287909, 0.67630587, 0.92954576, 0.17630587, 0.59621242, 0.92630587, 0.04065687,
    ...
    println!(
        "mindist diff: {:.2e}",
        (mindist - 0.25496610764841404_f64).abs()
    );
