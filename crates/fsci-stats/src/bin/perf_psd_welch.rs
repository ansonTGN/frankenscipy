...
fn main() {
    ...
    for &(n, w, ov) in &[(4096usize, 6usize, 3usize), (8192, 256, 128), (16384, 512, 256)] {
        let d = signal(n, 7);
        println!("n={n} w={w} digest={:016x}", digest(&psd_welch(&d, w, ov, 100.0)));
    }
    println!("===GOLDEN_PAYLOAD_END===");

    for &(n, w, ov) in &[(40000usize, 512usize, 256usize), (80000, 1024, 512), (120000, 2048, 1024)] {
        let d = signal(n, 7);
        let reps = 5;
        ...
        println!("n={n} w={w}  {:>10.3?}/call (acc={acc:.6})", t0.elapsed() / reps);
    }
}
