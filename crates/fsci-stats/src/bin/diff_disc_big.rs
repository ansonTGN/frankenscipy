...
fn em<D: DiscreteDistribution>(label:&str,d:&D,ks:&[u64]){
    ...
    for &k in ks { println!("{label},cdf,{k},{:.16e}",d.cdf(k)); println!("{label},sf,{k},{:.16e}",d.sf(k)); }
}
fn main(){
    ...
    em("binom|1000_0.3",&Binomial::new(1000,0.3),&[280,300,320,360]);
    em("yulesimon|1.2",&YuleSimon::new(1.2),&[5,50,500]);
    em("zipfian|2.0_1000",&Zipfian::new(2.0,1000),&[1,10,100,900]);
}
