...
pub use bessel::{
    ...
    jnjnp_zeros, jnyn_zeros, lmbda, log_ive_scalar,
...
pub use orthopoly::{
    ...
    assoc_legendre_p, assoc_legendre_p_all, ellip_harm, jacobi, js_roots, l_roots, la_roots,
    laguerre, legendre, legendre_p,
