...
pub use gamma::{
    ...
    gammaincc_scalar, gammaln, gammaln_scalar, gdtr, gdtrc, gdtria, gdtrib, gdtrix, loggamma,
    loggamma_scalar, multigammaln, pdtr, pdtrc, pdtri, pdtrik, perm, polygamma, rgamma, zeta,
    zetac,
};
pub use hyper::{
